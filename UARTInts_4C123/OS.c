...
uint32_t static LastPF0;  //Previous value
...
#define PF4 (*((volatile uint32_t *) 0x40025040)) /*TODO: get correct address*/
...
int OS_AddSW1Task(void(*task)(void), unsigned long priority){
  ...
  LastPF4 = PF4;
  NVIC_PRI7_R = (NVIC_PRI7_R&0xFF00FFFF) | (3<<21); //3, bits 23-21
